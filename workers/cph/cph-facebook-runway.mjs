...
function captionFor(item) {
  return buildFacebookCaption(item, hashtags);
}
...
const [queuePayload, scheduledPosts] = await Promise.all([
...
const snapshot = {
  ...
  supply: {
    ...
    recycle_image_backed: 0,
    recycle_policy: 'disabled_without_original_facebook_post_id',
